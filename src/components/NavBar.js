...
const CustomLink = ({href, title, className=""}) =>{
    ...
    return (
        <Link href = {href} className={`${className} relative group mx-2`}>
            {title}
...
const NavBar = () => {
  ...
  return (
    ...
    dark:text-light dark:bg-dark bg-light relative z-10  lg:px-16 md:px-12 sm:px-8'
    >
        <button className='flex-col justify-center  hidden lg:flex
        items-center ' onClick={handleClick} >
       ...
       <nav >
        ...
        <nav className='flex items-center justify-center flex-wrap'>
            <motion.a href='https://www.github.com/abiji-2020' target={"_blank"}
            whileHover={{y:-2}}
            whileTap={{scale:0.9}}
            className='w-6 mx-3 dark:text-dark dark:bg-light rounded-full'>
                <GithubIcon />
            </motion.a>
            <motion.a href='https://www.linkedin.com/in/abinand0911' target={"_blank"}
            whileHover={{y:-2}}
            whileTap={{scale:0.9}}
            className='w-6 mx-3'>
                <LinkedInIcon />
...

      {
        ...
        z-30 bg-dark/85 dark:bg-light/75 rounded-lg backdrop-blur-md py-32'>
        ...
        <nav  className='flex items-center flex-col justify-center'>
         ...
         <nav className='flex items-center justify-center flex-wrap my-2 '>
             ...
             whileHover={{y:-2}}
             whileTap={{scale:0.9}}
             className='w-6 sm:mx-1 mx-3 dark:bg-light rounded-full dark:text-dark bg-dark text-light'>
                 <GithubIcon />
             </motion.a>
             <motion.a href='https://www.linkedin.com/in/abinand0911' target={"_blank"}
             whileHover={{y:-2}}
